...
# --- modern architecture flags (DeepSeek / LLaMA style), default off = original GPT-2 ---
use_rmsnorm = False # RMSNorm instead of LayerNorm
use_rope = False    # RoPE instead of learned position embeddings
use_swiglu = False  # SwiGLU instead of GELU MLP
